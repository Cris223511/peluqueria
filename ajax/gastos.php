				...
				while ($reg = $rspta->fetch_object()) {
					...
					$data[] = array(
						"0" => '<div style="display: flex; flex-wrap: nowrap; gap: 3px;">' .
							...
							('<a target="_blank" href="../reportes/exTicketGasto.php?id=' . $reg->idgasto . '"> <button class="btn btn-success" style="color: black !important; height: 35px; color: white !important;"><i class="fa fa-print"></i></button></a>') .
							'</div>',
						"1" => $reg->caja,
						"2" => $reg->local,
