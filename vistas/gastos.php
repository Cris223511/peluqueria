              ...
              <div class="box-header with-border">
                <h1 class="box-title">Gastos
                  ...
                  <?php if ($_SESSION["cargo"] == "superadmin" || $_SESSION["cargo"] == "admin_total") { ?>
                    <a href="../reportes/rptgastos.php" target="_blank">
                      <button class="btn btn-secondary" style="color: black !important;">
                        <i class="fa fa-clipboard"></i> Reporte
                      </button>
                    </a>
                  <?php } ?>
                  <a href="#" data-toggle="popover" data-placement="bottom" title="<strong>Gastos</strong>" data-html="true" data-content="Módulo para registrar los gastos de la caja. <br><br><strong>Nota:</strong> al registrar el gasto, el monto a gastar reducirá al monto total de la caja." style="color: #002a8e; font-size: 18px;">&nbsp;<i class="fa fa-question-circle"></i></a>
                </h1>
              ...
              <div class="panel-body" style="height: max-content;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <input type="number" class="form-control" name="monto" id="monto" step="any" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="8" onkeydown="evitarNegativo(event)" onpaste="return false;" onDrop="return false;" step="any" min="0.1" placeholder="Ingrese el monto a gastar de la caja." required>
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <label>Concepto:</label>
                    <textarea type="text" class="form-control" name="descripcion" id="descripcion" maxlength="10000" rows="4" placeholder="Ingrese el concepto del gasto."></textarea>
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="modal-content">
          <div class="modal-header" style="background-color: #f2d150 !important; border-bottom: 2px solid #C68516 !important;">
            ...
            <div style="text-align: center; display: flex; justify-content: center; flex-direction: column; gap: 5px;">
              <h4 class="modal-title infotitulo" style="margin: 0; padding: 0; font-weight: bold; text-align: start;">GASTO DE CAJA</h4>
            </div>
          </div>
          <div class="panel-body">
            <div class="col-lg-12 col-md-12 col-sm-12" style="padding: 15px; background-color: white; overflow: auto; font-size: 16px; overflow: auto;">
              <div style="display: flex; gap: 5px; flex-direction: column;">
                ...
                <div style="display: flex; justify-content: start;">
                  <div style="width: 200px; min-width: 200px; font-weight: bold;">MONTO GASTADO:</div>
                  <div class="nowrap-cell" id="monto_gasto_mostrar"></div>
                </div>
                <div style="display: flex; justify-content: start;">
                ...
                <div style="display: flex; justify-content: start;">
                  ...
                  <div style="min-width: 300px;" id="descripcion_gasto"></div>
                </div>
              </div>
            </div>
          </div>
