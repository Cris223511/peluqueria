          ...
          <div class="col-md-12">
            <div class="box">
              <div class="box-header with-border">
                ...
                <a href="#" data-toggle="popover" data-placement="bottom" title="<strong>Reporte de métodos de pago</strong>" data-html="true" data-content="Módulo para ver el monto de los métodos de pago de las compras que se hicieron en tu local." style="color: #002a8e; font-size: 18px;">&nbsp;<i class="fa fa-question-circle"></i></a>
