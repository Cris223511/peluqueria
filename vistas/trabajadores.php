...
?>
            ...
            <div class="box">
              ...
              <div class="panel-body table-responsive" id="listadoregistros">
                <table id="tbllistado" class="table table-striped table-bordered table-condensed table-hover w-100" style="width: 100% !important;">
                  <thead>
                    <th>Opciones</th>
                    <th>Nombre</th>
                    <th style="width: 40%; min-width: 280px; white-space: nowrap;">Descripción de la marca</th>
              ...
              <div class="panel-body" style="height: 400px;" id="formularioregistros">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <label>Local(*):</label>
                    <select name="idlocal" id="idlocal" class="form-control" disabled>
  ...
  require 'footer.php';
  ?>
  <script type="text/javascript" src="scripts/trabajadores1.js"></script>
<?php
}
ob_end_flush();
?>