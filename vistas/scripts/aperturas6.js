		...
		message: `
			<form id="form_apertura" style="margin-bottom: 0px;">
				...
				<div class="form-group" style="margin-top: 15px; margin-bottom: 0px;">
					...
					<input type="number" class="form-control" name="monto" id="monto_inicial" step="any" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="8" onkeydown="evitarNegativo(event)" onpaste="return false;" onDrop="return false;" step="any" min="0" placeholder="Ingrese el monto inicial de la caja." required>
				</div>
			</form>
		`,
		buttons: {
